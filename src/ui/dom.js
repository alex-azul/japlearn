export function getDomRefs(doc = document) {
  return {
    ...
    intense: {
      ...
      promptLabel: doc.getElementById("intense-prompt-label"),
      ...
      textAnswerForm: doc.getElementById("intense-text-answer-form"),
      textAnswerInput: doc.getElementById("intense-text-answer-input"),
    ...
    intenseWeights: {
      ...
      title: doc.getElementById("intense-weights-title"),
      modeSelect: doc.getElementById("intense-weights-mode-select"),
